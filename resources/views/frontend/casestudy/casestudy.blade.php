                ...
                @foreach ($casestudy as $data)
                    <div class="col-md-4 d-flex ftco-animate">
                        <div class="blog-entry justify-content-end">
                            <a href="{{ route('CaseStudyDetails', $data->id)}}" class="block-20" style="background-image: url({{ asset('images/case_study/'.$data->created_at->format('Y/M/').'/'.$data->image) }});">
                            </a>
                            ...
                            <a href="{{ route('CaseStudyDetails', $data->id)}}">
