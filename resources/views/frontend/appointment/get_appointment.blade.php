...
<html lang="en">
    <head>
        ...
        <!-- Favicon -->
        <link href="{{ asset('frontendassets/js/main.js') }}img/favicon.ico" rel="icon">
        ...
        <div class="wrapper">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <input type="date" name="appointment_date" class="form-control" placeholder="Your Name" required="required" />
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <textarea class="form-control" name="summary" placeholder="Case Summary" required="required" ></textarea>
                                            </div>
                                        </div>
            ...
            <div class="footer">
                ...
                <div class="container copyright">
                    <div class="row">
                        <div class="col-md-6">
                            <p>&copy; <a href="https://paperart.digital/">Paper Art</a>, All Right Reserved.</p>
                        </div>
                        <div class="col-md-6">
                            <p>Designed By <a href="https://yeaminrabbi.eduanalytic.com/">Yeamin Rabbi</a></p>
                        </div>
                    </div>
                </div>
            </div>
